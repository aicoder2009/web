      ...
      <div className="max-w-[1800px] w-full flex items-center gap-6 relative">
        ...
        <div className="md:flex hidden gap-8 w-full justify-end items-center">
          <div className="flex gap-8 items-center">
            ...
            >
              <h4 className="text-[15px] font-normal font-[family-name:var(--font-geist-mono)] uppercase tracking-normal text-foreground-light hover:text-accent !opacity-100 transition-colors duration-200">
                Resume
              </h4>
            </a>
          </div>
          ...
          <div className="flex gap-2 lg:w-full justify-end items-center">
            <button className="group flex items-center hover:opacity-100 hover:text-accent transition-all duration-200 rounded-full p-2 h-8 w-auto opacity-50" aria-label="Open AI chat" style={{ marginRight: '-8px' }}>
              <svg
                width="16"
                height="16"
                viewBox="0 0 30 30"
                fill="none"
                className="group-hover:animate-[sparkleSpin_1.5s_ease-in-out_1]"
              >
        ...
        {/* Mobile: hamburger + RacheLLM */}
        <div className="md:hidden flex gap-4 items-center">
          <button className="group flex items-center hover:opacity-100 hover:text-accent transition-all duration-200 rounded-full p-2 h-8 w-auto opacity-50" aria-label="Open AI chat">
            <svg
              width="16"
              height="16"
              viewBox="0 0 30 30"
      ...
      {mobileOpen && (
        <nav className="md:hidden flex flex-col gap-4 pt-4 pb-2 w-full max-w-[1800px]">
          ...
          <a
            ...
            onClick={() => setMobileOpen(false)}
          >
            <h4 className="text-[15px] font-normal font-[family-name:var(--font-geist-mono)] uppercase tracking-normal text-foreground-light hover:text-accent transition-colors duration-200">
              Resume
            </h4>
          </a>
        </nav>
